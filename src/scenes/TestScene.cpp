...
TestScene::TestScene()
    ...
    , normalTexture_(Texture::makeWaveNormalMap(192, 192, 4, 0.65f))
    ...
    , groundMaterial_(makeMaterial(nullptr, { 205, 210, 205, 255 }, { 240, 244, 236, 255 }, { 70, 76, 84, 255 }, 0.34f, 0.96f, 0.02f, 10.0f, &normalTexture_, 0.32f))
