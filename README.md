...
- 摄像机模块，支持键盘移动、方向键视角旋转、鼠标右键拖动视角，并生成 View/Projection 矩阵。
...
- `1` Final：完整最终渲染，包含纹理、顶点颜色、多光源、Blinn-Phong 高光和阴影。
- `2` Albedo：只显示纹理采样和顶点颜色相乘后的基础颜色，用于检查纹理与 UV。
...
- `7` Light：使用白色材质显示纯光照贡献，用于观察多光源、漫反射、高光和阴影对亮度的影响。
